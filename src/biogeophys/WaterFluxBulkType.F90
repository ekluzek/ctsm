...
contains
  ...
  subroutine CleanBulk(this)
    ...
    deallocate(this%qflx_sat_excess_surf_col )
    deallocate(this%qflx_infl_excess_col     )
    deallocate(this%qflx_rain_plus_snomelt_col)
    deallocate(this%qflx_in_soil_col         )
    deallocate(this%qflx_in_soil_limited_col )
    deallocate(this%qflx_h2osfc_drain_col    )
    deallocate(this%qflx_top_soil_to_h2osfc_col)
    deallocate(this%qflx_in_h2osfc_col       )
    deallocate(this%qflx_h2osfc_to_ice_col   )
    deallocate(this%qflx_infl_excess_surf_col)
    ...
    call this%qflx_ice_dynbal_dribbler%Clean()
    call this%qflx_liq_dynbal_dribbler%Clean()

  end subroutine CleanBulk
